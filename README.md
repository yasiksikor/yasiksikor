...
Аналитик данных с опытом работы с SQL, Python (Pandas) и DataLens. Мой опыт в научной сфере научил меня работать с цифрами, выявлять причинно-следственные связи, важные для бизнеса, проверять предположения и обосновывать полученные результаты. 
Рассматриваю позицию junior-аналитика или стажера, где смогу помогать команде с задачами и прокачивать навыки.
...
![Seaborn](https://img.shields.io/badge/Seaborn-7aa6c5?style=flat-square)
